...
public class TaskB {
        ...
        public static void main(String[] args) {
            try (FileReader inp = new FileReader(dir(by.it.soldatenko.jd01_14.TaskB.class) + "text.txt");
                 PrintWriter out2= new PrintWriter(new FileWriter(dir(by.it.arekhava.jd01_14.TaskB.class)+"resultTaskB.txt"))
            ) {
                int c;
