...
public class TaskC {
    ...
    public static void main(String[] args) {
        try (PrintWriter ouT = new PrintWriter(new FileWriter(dir(by.it.arekhava.jd01_14.TaskC.class) + "resultTaskC.txt")))
        {
            printAll(dirSol(by.it.arekhava.jd01_14.TaskC.class), ouT);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
